...
public class ObstacleSpawner : MonoBehaviour
{
    ...
    public GameObject primaryGround;     // Set this as the main ground object for obstacles
    ...
    void SpawnObstacle()
    {
        ...
        Vector3 spawnPos = new Vector3(spawnPosX, 0.5f, Camera.main.transform.position.z + 15f); // Adjust based on view
        ...
        newObstacle.transform.parent = primaryGround.transform; // Set primary ground as parent
    }
}
